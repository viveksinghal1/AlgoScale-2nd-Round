...
/* harmony import */ var _service_token_interceptor_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./service/token-interceptor.service */ "./src/app/service/token-interceptor.service.ts");
...
let LoginComponent = class LoginComponent {
    constructor(_authService, _router, fb) {
        this._authService = _authService;
...
let AuthService = class AuthService {
    ...
    register(user) {
        ...
        return this.http.post(this.header + "/register", user, { headers })
...
module.exports = __webpack_require__(/*! D:\ALGOSCALE\AlgoScale-2nd-Round\frontend\src\main.ts */"./src/main.ts");
